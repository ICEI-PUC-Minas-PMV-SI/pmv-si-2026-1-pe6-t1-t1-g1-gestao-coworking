...
| 02/03 - 08/03 | Arquitetura de Software Distribuído - Unidade 3 | ✅ | Requisitos funcionais e não funcionais ( colocar no documento ) | Realizada a definição e documentação dos requisitos funcionais e não funcionais do sistema, com inclusão das informações no documento do projeto. |
