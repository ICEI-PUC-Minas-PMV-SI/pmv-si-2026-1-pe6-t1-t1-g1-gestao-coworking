...
&nbsp; &nbsp; &nbsp; A tipografia adotada utiliza fontes do React Native, garantindo boa legibilidade em diferentes tamanhos de tela e sistemas operacionais. Os títulos apresentam maior tamanho e peso (estando em negrito), destacando as principais informações da interface, enquanto os textos descritivos utilizam tamanhos menores e cores mais suaves para estabelecer uma hierarquia visual. 
